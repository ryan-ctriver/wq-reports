...
graph <- Turb %>%
  ...
  geom_hline(aes(yintercept = Turb_standardA, linetype = "VT A Std"), color = standardcolor) +
  geom_hline(aes(yintercept = Turb_standardB, linetype = "VT B Std"), color = standardcolor2) +
