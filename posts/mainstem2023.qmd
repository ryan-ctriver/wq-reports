...
![Source: Emojipedia](_images/pile-of-poo.gif){fig-alt="Animated pile of poo emoji" fig-align="right" width="150"}
:::

*Escherichia coli* is a coliform bacteria found in the guts of all warm-blooded animals including mammals, birds, and humans. Not all *E. coli* is pathogenic (illness causing), but some strains can be extremely harmful. It is used an indicator for fecal contamination of rivers and lakes. Because it is found in the gut, abundant *E. coli* numbers in water mean there is a higher likelihood that the water is contaminated with human or animal waste and that there is an increased risk of waterborne illness. This could be from one of the harmful strains of *E. coli* or other pathogenic organisms that are often found in human or animal waste but are much more difficult or costly to test for.

::: {style="float: left; position: relative; top: 0px; padding: 30px;"}
![Source: WikiCommons](_images/Escherichia_coli_wikicommons.jpg){fig-alt="Single E. coli organism colored purple" fig-align="right" width="250"}
:::
...
The graphic below is interactive. Hover your mouse over a point on the chart to highlight its counterpart on the map.
:::
...
The charts below are interactive. Select a sampling year from the tabs and hover your mouse over a column to see the date, the result, and to highlight other results from the same sampling day.
:::
